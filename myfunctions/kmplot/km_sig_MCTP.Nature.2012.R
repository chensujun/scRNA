...
mydata <- readRDS('./data/2019-02-09_MCTP.Nature.2012.rds');
# str(mydata)
...
clinical <- readRDS('./data/2019-02-09_MCTP.Nature.2012_survival.rds');
# str(clinical)
...
pdf(generate.filename('KM_MCTP.Nature.2012', paste0(mymethod, '_', gsub('\\..*', '', mylist)), 'pdf'));
myplot;
dev.off();
